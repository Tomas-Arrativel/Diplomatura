...
-- Tiempo de generación: 27-06-2023 a las 13:28:38
...
CREATE TABLE IF NOT EXISTS `empleados` (
  ...
  `nombre` varchar(43) COLLATE utf8mb3_spanish_ci NOT NULL,
  `apellido` varchar(50) COLLATE utf8mb3_spanish_ci NOT NULL,
  `trabajo` varchar(100) COLLATE utf8mb3_spanish_ci NOT NULL,
  `edad` int NOT NULL,
  `salario` int NOT NULL,
  `mail` varchar(100) COLLATE utf8mb3_spanish_ci NOT NULL,
  PRIMARY KEY (`id_emp`)
